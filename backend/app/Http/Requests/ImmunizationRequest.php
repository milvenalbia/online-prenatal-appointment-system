...
class ImmunizationRequest extends FormRequest
{
    ...
    protected function validateTetanusSequence($validator)
    {
        ...
        $this->validateDoseInterval($validator, 'tetanus_first_given', 'tetanus_second_given', 28);
        $this->validateDoseInterval($validator, 'tetanus_second_given', 'tetanus_third_given', 28);
    }
