      ...
      case 4:
        return (
          <div className='space-y-6'>
            ...
            {/* National Safe Motherhood Program Form Preview */}
            <div
              ref={printRef}
              className='bg-white border-2 border-gray-300 p-4 text-xs overflow-x-auto'
            >
              {/* Header */}
              <div className='text-center mb-4'>
                ...
                <h5 className='font-bold text-xs'>PREGNANCY TRACKING</h5>
              </div>
              ...
              <div className='grid grid-cols-2 gap-8 mb-4 text-xs'>
                <div className='space-y-1'>
                  ...
                  <div className='flex'>
                    <span className='w-16'>Province:</span>
                    <span className='border-b border-black flex-1 px-1'>
                      {formData.province || ''}
                    </span>
                  </div>
                  <div className='flex'>
                    <span className='w-16'>Municipality:</span>
                    <span className='border-b border-black flex-1 px-1'>
                      {formData.municipality || ''}
                    </span>
                  </div>
                  <div className='flex'>
                    <span className='w-16'>Barangay:</span>
                    <span className='border-b border-black flex-1 px-1'>
                      {formData.barangay || ''}
                    </span>
                  </div>
                ...
                <div className='space-y-1'>
                  <div className='flex'>
                    <span className='w-20'>Birthing Center:</span>
                    <span className='border-b border-black flex-1 px-1'>
                      {formData.birthing_center || ''}
                    </span>
                  </div>
                  ...
                  <div className='flex'>
                    <span className='w-20'>Referral Center:</span>
                    <span className='border-b border-black flex-1 px-1'>
                      {formData.referral_center || ''}
                    </span>
                  </div>
              ...
              {/* Main Table */}
              <table
                className='w-full border-2 border-black text-[8px]'
              ...
              >
                ...
                <thead>
                  <tr className='bg-gray-100'>
                    <th
                      rowSpan={2}
                      className='border border-black p-1 text-center font-bold w-8'
                    >
                      No.
                    </th>
                    <th
                      rowSpan={2}
                      className='border border-black p-1 text-center font-bold w-24'
                    >
                      Name
                    </th>
                    <th
                      rowSpan={2}
                      className='border border-black p-1 text-center font-bold w-10'
                    >
                      Age
                    </th>
                    <th
                      rowSpan={2}
                      className='border border-black p-1 text-center font-bold w-16'
                    >
                      Gravidity
                    </th>
                    <th
                    ...
                    <th
                      ...
                      className='border border-black p-1 text-center font-bold'
                    >
                      Mother and Child Prenatal Check-up
                    </th>
                  </tr>
                  <tr className='bg-gray-50'>
                    <th className='border border-black p-1 text-center font-bold text-[7px] w-10'>
                      Month
                    </th>
                    <th className='border border-black p-1 text-center font-bold text-[7px] w-8'>
                      Day
                    </th>
                    <th className='border border-black p-1 text-center font-bold text-[7px] w-12'>
                      Year
                    </th>
                    <th className='border border-black p-1 text-center font-bold text-[7px] w-12'>
                      1st visit Date
                    ...
                    <th className='border border-black p-1 text-center font-bold text-[6px] w-20'>
                      Day of Discharge/ 24 hours after birth
                    </th>
                    <th className='border border-black p-1 text-center font-bold text-[6px] w-20'>
                ...
                <tbody>
                  ...
                  <tr className='h-8'>
                    ...
                    <td className='border border-black p-1 text-left text-[9px]'>
                      {patientType === 'new'
                        ? `${formData.firstname || ''} ${
                            formData.middlename || ''
                          } ${formData.lastname || ''}`.trim()
                    ...
                    <td className='border border-black p-1 text-center text-[9px]'>
                      {formData.edc
                        ? new Date(formData.edc).getMonth() + 1
                        : ''}
                    </td>
                    <td className='border border-black p-1 text-center text-[9px]'>
                      {formData.edc ? new Date(formData.edc).getDate() : ''}
                    </td>
                    <td className='border border-black p-1 text-center text-[9px]'>
                      {formData.edc ? new Date(formData.edc).getFullYear() : ''}
                    </td>
              ...
              <div className='grid grid-cols-2 gap-8 mt-4 text-xs'>
                <div className='space-y-1'>
                  <div className='flex'>
                    <span className='w-20'>Name of BHW:</span>
                    <span className='border-b border-black flex-1 px-1'>
                      {formData.barangay_worker_id || ''}
                    </span>
                  </div>
                  <div className='flex'>
                    <span className='w-20'>Name of Midwife:</span>
                    <span className='border-b border-black flex-1 px-1'>
                      {formData.midwife_id || ''}
                    </span>
                  </div>
                ...
                <div className='space-y-1'>
                  <div className='flex'>
                    <span className='w-24'>Barangay Health Station:</span>
                    <span className='border-b border-black flex-1 px-1'>
                      {formData.barangay_health_station || ''}
                    </span>
                  </div>
                  <div className='flex'>
                    <span className='w-24'>Rural Health Unit:</span>
                    <span className='border-b border-black flex-1 px-1'>
                      {formData.rural_health_unit || ''}
                    </span>
                  </div>
            ...
            {isSubmitted ? (
              ...
              <div className='bg-emerald-50 border border-emerald-200 p-4 rounded-lg'>
                <p className='text-emerald-800 text-sm'>
                  Please review all information in the form preview above before
                  submitting. Once submitted, a new pregnancy tracking record
                  will be created and you'll be able to print it as a PDF.
                </p>
              </div>
            )}
          </div>
